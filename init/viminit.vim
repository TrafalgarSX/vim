...
"
" Maintainer: guoyawen98(at) gmail.com
" Last Modified: 2023/02/16 16:38
"
...
set timeout
set timeoutlen=500 " 按键映射
set ttimeout
set ttimeoutlen=50 " 按键序列
set cmdheight=2
set ruler
set nopaste
...
"----------------------------------------------------------------------
if has('gui_running')
	" keymaps.vim already have this setting
